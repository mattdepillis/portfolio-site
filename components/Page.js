...
const Page = ({
  rootPath,
  page: { site, pageId, recordMap },
  parent,
  backArrow,
  additionalContent
}) => {
  // renders a spinner on fallback to prevent page load failure
  ...
  // grab the proper head title for any given page
      ...
      <NotionRenderer
        ...
        components={{
          pageLink: ({
            ...
            */
            if (props.className.includes('notion-page-link') && title === 'Media') {
              let properties
